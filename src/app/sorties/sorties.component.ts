...
export class SortiesComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA)public data:number,private etageppService:EtagessService, private route:ActivatedRoute, private router:Router, private ref:MatDialogRef<SortiesComponent>/*,private datePipe: DatePipe*/) { }
